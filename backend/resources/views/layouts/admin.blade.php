...
<body class="font-sans antialiased">
    ...
    <div class="min-h-full">
        <nav x-data="{ menu: false }" class="bg-gray-800">
            ...
            <transition enter-active-class="transition ease-out duration-500" enter-from-class="transform opacity-0 scale-95" enter-to-class="transform opacity-100 scale-100" leave-active-class="transition ease-in duration-100" leave-from-class="transform opacity-100 scale-1000" leave-to-class="transform opacity-0 scale-95">
