...
export default function Register() {
  ...
  const handleRegister = async (e) => {
    ...
    api().get('/sanctum/csrf-cookie').then(() => {
      api().post('api/v1/register', requestBody).then(response => {
  ...
  return (
    <Box sx={ authBg }>
      <Box component="form" onSubmit={ handleRegister } sx={ authBox }>
        ...
        <Typography component="h2" variant="h5" align="center" gutterBottom sx={ { color: "primary.main", fontWeight: "bold" } }>Sign up</Typography>
        ...
        />
        <FormControlLabel control={ <Checkbox required checked={ agree } onChange={ e => setAgree(!agree) } /> } label={
          <Typography>
            Agree with <Link href="/terms" target="_blank" rel="noopener">
              <Typography component="a" variant="subtitle1" color="black" sx={ { textDecoration: "underline" } }>Terms and Conditions</Typography>
            </Link>
          </Typography>
